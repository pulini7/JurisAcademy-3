        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {FEATURES.map((feature, index) => (
            <RevealOnScroll key={feature.id} delay={index * 100}>
              <div className="relative group p-6 bg-slate-900/30 border border-slate-800 hover:border-cyan-500/60 transition-all duration-300 hover:bg-slate-900/60 hover:-translate-y-2 overflow-hidden rounded-xl h-full">
                {/* Top gradient line */}
